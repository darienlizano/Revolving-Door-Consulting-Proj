...
Similarly to the graph used for the first part of question 7, the majority of recipients live in families than make over $25k. Within this group, the vast majority obtained a High School degree as their highest degree (706). This number alone tops the number of those who acheived a Bachelors (453) and a Graduate Degree (247) across all family income groups. This can mean one of two things; either Bachelor and Gradute Degrees are steadily on the rise for those making 25k or more, or the current labor force does not have a demand for a Bachelor or Graduate degree. If we were able to analyze the same variables across different years, we would be able to have a more definitve answer. Our recommendation to the Foundation is that it explore data collection in this area for future analyses. 
